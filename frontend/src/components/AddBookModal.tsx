...
function AddBookModal() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        dispatch(addBook({ title, author, genre, publicationDate }));
        setIsOpen(false);
    };
    ...
    return (
        <>
            <button
                ...
                className="ml-auto block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
            >
                Add New Book
            </button>
